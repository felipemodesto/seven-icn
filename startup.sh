...
if [ "Brick" = "${HOSTNAME}" ]; then
	...
	/home/felipe/Dropbox/uOttawa/Research/Code/VEINS_5/sumo-launchd.py -vv -c sumoD
	...
	/home/felipe/Dropbox/uOttawa/Research/Code/VEINS_5/sumo-launchd.py -vv -c sumo
	...
	/Users/felipe/Dropbox/uOttawa/Research/Code/VEINS_5/sumo-launchd.py -vv -c sumoD
else
